import pytest
from ansiconverter import RGBtoHEX, RGBtoANSI, HEXtoRGB, HEXtoANSI
...
class TestsConverter:
    ...
    @classmethod
    def setup_class(cls):
        cls.rgb_color = (13, 24, 128)
        cls.hex_color = "#0d1880"
        cls.text = "Valid Input"
    ...
    def test_RGBtoHEX_valid_input(self, input_data, expected):
        """Test the conversion from RGB to HEX with a correct list of colours"""
        assert RGBtoHEX(input_data) == expected
    ...
    def test_RGBtoHEX_list_input(self, input_data, expected):
        """Test the conversion from RGB to HEX with a correct list of colours"""
    ...
    def test_RGBtoANSI_valid_input(self):
        ...
        assert (
            RGBtoANSI("Valid Input", (125, 125, 125))
            == "\x1B[38;2;125;125;125mValid Input\x1b[0m"
        )
    ...
    def test_RGBtoANSI_background(self):
        assert (
            RGBtoANSI("Test", (0, 10, 24), (255, 255, 255))
            == f"\033[38;2;{0};{10};{24}m\033[48;2;{255};{255};{255}mTest\x1b[0m"
        )
